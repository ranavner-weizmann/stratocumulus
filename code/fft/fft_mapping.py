...
def generate_fft_frequency_heatmap(image_path, block_size=44, log_scale=True, sigma=1.0):
    ...
    plt.xlabel('X Blocks')
    plt.ylabel('Y Blocks')
    plt.savefig('../../data/cloud_frequency_heatmap/fft_frequency_heatmap.png')
    plt.show()
...
def visualize_frequency_bands(image_path, block_size=44, num_bands=4, sigma=1.0):
    ...
    plt.tight_layout()
    plt.savefig('../../data/cloud_frequency_heatmap/frequency_bands.png')
    plt.show()
...
if __name__ == "__main__":
    ...
    if not os.path.exists('../../data/cloud_frequency_heatmap'):
        os.makedirs('../../data/cloud_frequency_heatmap')

    # Replace with your image path
    image_path = "../../data/black_images_removed/20190801-12-11-93-92.jpeg"
